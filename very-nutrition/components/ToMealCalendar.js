...
export default function ToMealCalendar() {
  ...
  <View style={{ flex : 1, backgroundColor : 'white', borderColor : 'black', borderRadius : AppSizes.HomeScreenElementBorderRadius, borderWidth : AppSizes.HomeScreenElementBorderWidth, height : AppSizes.HomeScreenElementHeight, padding : AppSizes.HomeScreenElementPadding }}>
    <TouchableOpacity style={{ flex : 1 }} onPress={() => navigation.push('MealCalendar')}>
      <Text style={{ flex : 1, fontSize : AppSizes.HomeScreenElementTextSize, textAlign : 'center', textAlignVertical : 'center' }}>ToMealCalendar</Text>
    </TouchableOpacity>
  </View>
  );
}
